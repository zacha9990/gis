...
jQuery(document).ready(function($) {
    ...
    */
    ...
    ----------------------------------------------------------------------*/
        ...
        map.on('singleclick', function(evt) {
            ...
            if (feature) {           
                ...
                var columns = propLayer.shownColumn;
                console.log(columns);
                
                if (columns != null && columns != ""){
                    var arrayOfColumn = columns.split(",");
                    console.log(arrayOfColumn);
                    console.log(props);
                    var propValue;
                    ...
                    for(var propName in props){
                        ...
                        if (jQuery.inArray(propName, arrayOfColumn) > -1){
                        console.log($.inArray(propName, arrayOfColumn));
                            info += "<th>" + propName + "</th>";
                        }                
                    }
    ...
    //---------- yang ini jangan dihapus-----------------------//
      ...
      var kelaslevel0 = {};var styleCache0 = {}; kelaslevel0 = {'Default Simbol': 'grey',};
    ...
    /*---------------------------------------------------------------------
                              style Default
    ----------------------------------------------------------------------*/
    function styleDefault(color = [0, 0, 0, 1]) {
                                    ...
                                    if (layerGeom == 'st_multilinestring' || layerGeom == 'st_linestring' || layerGeom == 'st_point' || layerGeom == 'st_multipoint') {
                                        window[layerFile] = new ol.layer.Vector({
                                            ...
                                            source: new ol.source.Vector({
                                                format: new ol.format.GeoJSON(),
                                               // url: 'inc/geojson.php?id=' + layerId,
                                            ...
                                            style: function(feature, resolution) {
                                                ...
                                                if (layerGeom != 'st_multilinestring') {
                                                    ...
                                                    return [styleDefault(kelasLevel[kelas])];
                                                }
                                            }
                                        }); //ol.source.Vector
                                        ...
                                        console.log("string");
                                        //fetch('inc/geojson.php?id=' + layerId, {
    ...
    function aksimodal(id,namelayer)
    {
        ...
        var namelayer   =  namelayer; 
            ...
            $.ajax({
                ...
                data:{id:id,namelayer:namelayer},
                dataType: 'json',
                success: function(data)
                {
                    if(!data.error)
    ...
    ----------------------------------------------------------------------*/
        ...
        {
             $("#myModalDownload").modal({backdrop: 'static',keyboard: false});
